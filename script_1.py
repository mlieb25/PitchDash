...
base_dir = 'streamlit_investor_dashboard_fixed'
os.makedirs(base_dir, exist_ok=True)

# Create a completely standalone app.py without ANY utils dependencies
app_py_standalone = '''"""
...
# Write the standalone app.py
with open(f'{base_dir}/app.py', 'w') as f:
    f.write(app_py_standalone)

print("="*80)
print("✅ CREATED COMPLETELY STANDALONE app.py")
print("="*80)
print("\n📝 Key changes:")
print("  ❌ REMOVED: from utils.calculations import ...")
print("  ❌ REMOVED: from utils.visualizations import ...")
print("  ❌ REMOVED: sys.path manipulations")
print("\n  ✅ ADDED: All helper functions directly in app.py")
print("     • format_currency()")
print("     • format_percentage()")
print("     • format_multiple()")
print("\n  ✅ ZERO external dependencies (except pandas, streamlit, plotly)")
print("  ✅ No utils/ folder needed at all!")
print("\n" + "="*80)
print("This version will work 100% without any utils module!")
print("="*80)
