...
# Create Page 4: Investment Scenarios (Interactive Calculator)
page_scenarios = '''"""
...
with open(f'{base_dir}/pages/4_🎯_Investment_Scenarios.py', 'w') as f:
    f.write(page_scenarios)

print("✓ Created pages/4_🎯_Investment_Scenarios.py")
